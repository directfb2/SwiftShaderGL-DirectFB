...
//   are tracked in the intermediate representation.
//

//
// Symbol base class, can build functions or variables.
//
class TSymbol
{
public:
...
protected:
	...
	// unionArray when this object is destroyed.
	ConstantUnion *unionArray;
	TType *arrayInformationType; // for updating maxArraySize in all the references to a given symbol
};
...
{
public:
	TSymbolTable() : mGlobalInvariant(false)
	{
