...
#ifndef _PREPROCESSOR_DIRECTIVE_PARSER_H_
#define _PREPROCESSOR_DIRECTIVE_PARSER_H_
...
private:
	...
	bool mSeenNonPreprocessorToken; // Tracks if a non-preprocessor token has been seen yet.
