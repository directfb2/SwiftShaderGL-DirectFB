...
#ifndef _INTERMEDIATE_INCLUDED_
#define _INTERMEDIATE_INCLUDED_

#include "ConstantUnion.h"
#include "Types.h"

//
// Operators used by the high-level (parse tree) intermediate representation.
//
enum TOperator
{
	EOpNull,
...
public:
	...
	bool isRegister() const { return type.isRegister(); }
...
protected:
	...
	TString name;
	bool userDefined; // for user defined function names
