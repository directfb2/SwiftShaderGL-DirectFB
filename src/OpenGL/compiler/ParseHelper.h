...
#ifndef _PARSE_HELPER_INCLUDED_
#define _PARSE_HELPER_INCLUDED_
...
public:
	...
	int compileOptions;          // compile options
	const char* sourcePath;      // path of source file or null
	bool lexAfterType;           // true if type recognized, looking only for an identifier
	...
	void info(const TSourceLoc &loc, const char* reason, const char* token, const char* extraInfo="");
	...
	TIntermAggregate* addInterfaceBlock(const TPublicType& typeQualifier, const TSourceLoc& nameLine, const TString& blockName, TFieldList* fieldList, const TString* instanceName, const TSourceLoc& instanceLine, TIntermTyped* arrayIndex, const TSourceLoc& arrayIndexLine);
	...
	// Returns true if an error was raised due to the declaration of this struct.
...
private:
	...
	GLenum mShaderType;                // vertex or fragment language
	int mShaderVersion;                // shader version
	...
	bool mChecksPrecisionErrors;       // true if an error will be generated when a variable is declared without precision
