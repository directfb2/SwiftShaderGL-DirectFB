...
enum
{
	...
	MAX_VERTEX_UNIFORM_VECTORS = sw::VERTEX_UNIFORM_VECTORS - 3,
	MAX_VARYING_VECTORS = std::min<int>(sw::MAX_FRAGMENT_INPUTS, sw::MAX_VERTEX_OUTPUTS),
	...
	MAX_FRAGMENT_UNIFORM_VECTORS = sw::FRAGMENT_UNIFORM_VECTORS - 3,
	...
	MAX_COLOR_ATTACHMENTS = std::max<int>(MAX_DRAW_BUFFERS, 8),
...
public:
	...
	int typeSize() const
	{
		...
		default:                             return mSize * sizeof(GLfloat);
		}
	}
	...
	inline float getCurrentValueF(int i) const
	{
		...
		default:              return mCurrentValue[i].f;
		}
	}
	...
	inline GLint getCurrentValueI(int i) const
	{
		...
		default:              return mCurrentValue[i].i;
		}
	}
	...
	inline GLuint getCurrentValueUI(int i) const
	{
		...
		default:              return mCurrentValue[i].ui;
		}
	}
...
public:
	...
	void blitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, bool filter, bool allowPartialDepthStencilBlit);
