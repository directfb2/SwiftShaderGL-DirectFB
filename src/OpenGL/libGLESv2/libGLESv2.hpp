...
#ifndef LIBGLESv2_HPP_
#define LIBGLESv2_HPP_
...
public:
	...
	void (GL_APIENTRY *glReadnPixelsEXT)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLvoid *data);
