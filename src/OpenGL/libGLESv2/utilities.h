...
#ifndef LIBGLESV2_UTILITIES_H_
#define LIBGLESV2_UTILITIES_H_
...
// Parse the base uniform name and array index.
// Returns the base name of the uniform.
// outSubscript is set to GL_INVALID_INDEX if the provided name is not an array
// or the array index is invalid.
