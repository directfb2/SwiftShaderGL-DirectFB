...
private:
	...
	void RET();
	void LEAVE();
	void TEX(Vector4f &dst, Vector4f &src0, const Src &src1);
	void TEXOFFSET(Vector4f &dst, Vector4f &src0, const Src &src1, Vector4f &offset);
	void TEXLOD(Vector4f &dst, Vector4f &src, const Src &src1, Float4 &lod);
	void TEXLODOFFSET(Vector4f &dst, Vector4f &src, const Src &src1, Vector4f &offset, Float4 &lod);
	void TEXELFETCH(Vector4f &dst, Vector4f &src, const Src &src1, Float4 &lod);
	void TEXELFETCHOFFSET(Vector4f &dst, Vector4f &src, const Src &src1, Vector4f &offset, Float4 &lod);
	void TEXGRAD(Vector4f &dst, Vector4f &src, const Src &src1, Vector4f &dsx, Vector4f &dsy);
	void TEXGRADOFFSET(Vector4f &dst, Vector4f &src, const Src &src1, Vector4f &dsx, Vector4f &dsy, Vector4f &offset);
	...
	std::unordered_map<unsigned int, std::vector<BasicBlock*>> callRetBlock; // list of call site return blocks
